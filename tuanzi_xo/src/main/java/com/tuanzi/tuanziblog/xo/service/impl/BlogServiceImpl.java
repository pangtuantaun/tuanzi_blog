...
import com.tuanzi.tuanziblog.commons.entity.*;
...
import com.tuanzi.tuanziblog.xo.mapper.BlogMapper;
import com.tuanzi.tuanziblog.xo.mapper.BlogSortMapper;
import com.tuanzi.tuanziblog.xo.mapper.TagMapper;
import com.tuanzi.tuanziblog.xo.service.*;
import com.tuanzi.tuanziblog.xo.utils.WebUtil;
import com.tuanzi.tuanziblog.xo.vo.BlogVO;
...
public class BlogServiceImpl extends SuperServiceImpl<BlogMapper, Blog> implements BlogService {
    ...
    public String uploadLocalBlog(List<MultipartFile> filedatas) {
        ...
        if (systemConfig == null) {
            ...
            if (EOpenStatus.OPEN.equals(((SystemConfig) systemConfig).getUploadQiNiu()) && (StringUtils.isEmpty(systemConfig.getQiNiuPictureBaseUrl()) || StringUtils.isEmpty(systemConfig.getQiNiuAccessKey())
