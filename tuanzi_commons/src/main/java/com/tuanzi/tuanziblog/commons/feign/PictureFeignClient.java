package com.tuanzi.tuanziblog.commons.feign;

import com.tuanzi.tuanziblog.commons.config.feign.FeignConfiguration;
import com.tuanzi.tuanziblog.commons.fallback.PictureFeignFallback;
 ...
 * @author 陌溪
 */
@FeignClient(name = "tuanzi-picture", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
